...
class UpdateEvent extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Updateevent();
}

class Updateevent extends State<UpdateEvent> {
  ...
  void initState() {
    super.initState();
    titelController = TextEditingController(text: widget.event.titel);
    descController = TextEditingController(text: widget.event.desc);
    selectedCategoriesIndex = categories.indexOf(widget.event.category);
    selectedDate = DateTime.fromMillisecondsSinceEpoch(widget.event.date);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("update_event".tr(), style: Theme.of(context).textTheme.displayMedium),
        centerTitle: true,
        backgroundColor: Theme.of(context).scaffoldBackgroundColor,
        leading: Padding(
          ...
          children: [
            ...
            MaterialButton(
              onPressed: () {
                ...
                Firebasefunctions.updateEvent(event);
                Navigator.pop(context);
              },
